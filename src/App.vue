<template>
  <div class="bg-white px-6 shadow-2xl m-8 rounded-lg w-full h-full">
    <div>
    ...
    <div class="flex flex-row h-full w-full px-auto py-auto">
      <SideBar />
    </div>
  </div>
</template>
...
<style scoped></style>./components/SideBar.vue
